...
// ConnectionLifecycleError identifies a failure in the upstream connection
// lifecycle. Auth managers may retry another credential without cooling the
// credential that observed the connection failure.
